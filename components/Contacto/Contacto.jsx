         ...
         <div className="2xl:container mx-auto">
            <div className="md:flex md:items-center justify-between">  {/* columns */}
               <div className="block basis-0 flex-shrink lg:flex-none lg:w-2/5 flex-grow p-2 "> {/* column */}
                  <h2 className="font-bold text-3xl text-azul-oscuro md:text-5xl mb-5 after:w-14 after:h-2 after:ml-0 after:mx-auto after:mt-4 after:bg-azul-claro after:block after:rounded">Contacto</h2>
                  <p className="md:text-lg mb-6">Para recibir más información, completa el formulario.</p>

                  <div className="flex items-center mb-6 max-w-[370px] w-full">
                     <div
                        className="max-w-[60px] sm:max-w-[70px] w-full h-[60px] sm:h-[70px] flex items-center justify-center mr-6
                        overflow-hidden
                        bg-slate-200
                        text-primary
                        rounded
                     ...
                     <div className="w-full">
                        <h4 className="font-bold text-dark text-xl mb-1">Nuestra Ubicación</h4>
                        <p className="text-base">
                           Calle Almirante Guisse #243 - Chiclayo
                        </p>
                     </div>
                  </div>

                  <div className="flex mb-6 max-w-[370px] w-full">
                     <div
                        className="
                        max-w-[60px]
                        sm:max-w-[70px]
                     ...
                     <div className="w-full">
                        <h4 className="font-bold text-dark text-xl mb-1">Teléfono</h4>
                        <p className="text-base">(+51) 970 555 683</p>
                     </div>
                  </div>
                  ...
                  <div className="flex mb-6 max-w-[370px] w-full">
                     ...
                     <div className="w-full">
                        ...
                        <p className="text-base">contacto@ayllukaypi.pe</p>
                     </div>
                  </div>
               </div>

               <div className="w-full md:w-1/2 lg:w-1/2 xl:w-5/12 2xl:w-4/12">
                  <div className="bg-white relative rounded-lg p-8 sm:p-11 shadow-lg">
                     <form>
                        <div>
                           <h3 className="text-3xl mb-6 text-center font-bold">Envíanos un mensaje</h3>
                        </div>
                        <div className="mb-6">
                           <input
                              type="text"
                              ...
                              focus:ring-blue-500 focus:border-azul-oscuro
                              hover:
                              "
                           />
                        </div>
                     ...
                     <div>
                        <span className="hidden md:block absolute -top-10 -right-5 z-[-1]">
                           <svg
                              width="100"
                              height="100"
                              viewBox="0 0 100 100"
